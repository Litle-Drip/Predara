  ...
  return `
    ...
    <div class="mi-card">
      ...
      ${hasRules
        ...
        : `<div class="resolution-fallback">See the market source for resolution details.${safeUrl(norm.sourceUrl) ? ` <a href="${esc(safeUrl(norm.sourceUrl))}" target="_blank" rel="noopener" class="link-accent">View original market ↗</a>` : ""}</div>`
      }
    </div>` : ""}
